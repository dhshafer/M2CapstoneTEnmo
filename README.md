...
3. (DONE) As an authenticated user of the system, I need to be able to see my Account Balance.
4. (ONGOING) As an authenticated user of the system, I need to be able to *send* a transfer of a specific amount of TE Bucks to a registered user.
   1. (DONE) I should be able to choose from a list of users to send TE Bucks to.
   2. I must not be allowed to send money to myself.
   3. (DONE) A transfer includes the User IDs of the from and to users and the amount of TE Bucks.
   4. (DONE) The receiver's account balance is increased by the amount of the transfer.
   5. (DONE) The sender's account balance is decreased by the amount of the transfer.
   6. I can't send more TE Bucks than I have in my account.
   7. I can't send a zero or negative amount.
   8. (DONE) A Sending Transfer has an initial status of *Approved*.
5. (DONE**Server Only) As an authenticated user of the system, I need to be able to see transfers I have sent or received.
6. (DONE**Server Only) As an authenticated user of the system, I need to be able to retrieve the details of any transfer based upon the transfer ID.
